				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="Understand ye the kingdom part 1"
							loading="lazy"
						/>
				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="Understand ye the kingdom part 2"
							loading="lazy"
						/>
						<div className="card-body p-4">
							<h4 className="card-title">Understand ye the kingdom? Part 1</h4>
				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="My little children, love not the world"
							loading="lazy"
						/>
						<div className="card-body p-4">
				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="The coming kingdom and its glory. Part 1"
							loading="lazy"
						/>
						<div className="card-body p-4">
				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="The coming kingdom and its glory. Part 2"
							loading="lazy"
						/>
						<div className="card-body p-4">
				...
				<div className="col-md-6 col-lg-4 mb-4 mb-lg-5" data-aos="fade-up">
					<div className="card bg-light shadow h-100">
						<img
							...
							alt="What meant these sayings of the Lord?"
							loading="lazy"
						/>
						<div className="card-body p-4">
